      ...
      >
        ...
        <g>
          ...
          <path
            ...
            transform="translate(0 0)"
          ></path>
          <circle className={styles.cls1} cx="76.09" cy="264.78" r="8.83"></circle>
          <circle className={styles.cls1} cx="101.86" cy="250.05" r="8.83"></circle>
          <circle className={styles.cls1} cx="126.55" cy="235.96" r="8.83"></circle>
          <circle className={styles.cls1} cx="367.46" cy="93.05" r="8.83"></circle>
          <path
            className={styles.cls1}
